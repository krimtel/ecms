	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				redirect('admin/Admin_ctrl/dashboard', 'refresh');
			}
			else
			{
				...
				$data['main_contant'] = $this->load->view('admin/pages/login',$data,TRUE);
				$this->load->view('admin/comman/index',$data);
				//redirect('admin/admin', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
...
// 			);
			...
			$this->load->view('admin/comman/index',$data);
			//redirect('admin/admin', 'refresh');
			//$this->_render_page('admin/admin', 'refresh');
		}
	}
